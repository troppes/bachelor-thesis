...
Auf das System wird zudem die MariaDB Datenbank von Dietrich-Online Projekt als Datenquelle eingespielt. Zudem mussten einige Programme während der Vorbereitung des Servers durch die Administratoren aufgespielt werden. Eine genaue Liste findet sich im Anhang. Diese Programme werde daher auch als gegeben bewertet.
