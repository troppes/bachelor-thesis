...
\begin{document}
%------------------------- Titelblatt -------------------------------------
\title{Einsatz eines Enterprise Serach Engine im Dietrich-Online Projekt}
\project{Bachelor-Abschlussarbeit}
%--------------------------------------------------------------------------
\supervisor{Titel Vorname Name} 		% Betreuer der Arbeit
\author{Florian Reitz}							% Autor der Arbeit
\groupid{GruppenID}
\address{Trier,14.10.2019} 							% Im Zusammenhang mit dem Datum wird hinter dem Ort ein Komma angegeben
\submitdate{15.03.2019} 				% Abgabedatum
%\begingroup
