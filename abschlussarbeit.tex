...
%--------------------------------------------------------------------------
\supervisor{Professor Christian Schmitz} 		% Betreuer der Arbeit
\author{Florian Reitz}							% Autor der Arbeit
\groupid{101}
\address{Trier, 15.10.2019} 							% Im Zusammenhang mit dem Datum wird hinter dem Ort ein Komma angegeben
